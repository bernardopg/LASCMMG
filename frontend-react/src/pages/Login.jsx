...
const Login = () => {
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    try {
      ...
      showError(error.response?.data?.message || 'Falha na autenticação. Verifique suas credenciais.');
    } finally {
      setIsLoading(false);
      setSubmitting(false);
    }
                  ...
                  <Field
                    ...
                    className={`appearance-none rounded-none relative block w-full px-3 py-2 border ${
                      errors.email && touched.email
                        ...
                        : 'border-gray-300 placeholder-gray-500 text-gray-900 focus:ring-primary focus:border-primary'
