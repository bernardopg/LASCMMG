...
const SettingsPage = () => {
  return (
    <div className="py-8">
      <h1 className="text-2xl font-bold mb-4 text-gray-100">Configurações (Admin)</h1>
      <div className="bg-slate-800 rounded-lg shadow p-6">
        ...
        <ul className="list-disc pl-6 text-gray-400">
          ...
          <li>
            ...
            <Link to="/admin/security/honeypots" className="text-primary hover:underline">
              Configurações do Honeypot
            </Link>
            ).
          </li>
        </ul>
        <div className="mt-6 p-4 bg-yellow-900/20 rounded">
