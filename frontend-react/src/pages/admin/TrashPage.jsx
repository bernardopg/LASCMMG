...
import { FaTrashAlt, FaUndo } from 'react-icons/fa'; // Ícones para ações
import { useMessage } from '../../context/MessageContext';
import { getTrashItems, permanentlyDeleteTrashItem, restoreTrashItem } from '../../services/api';
  ...
  return (
    <div className="py-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-100">Lixeira (Admin)</h1>
        <select
          className="form-select mt-1 block w-auto py-2 px-3 border border-slate-600 bg-slate-700 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm text-gray-100"
          value={filterType}
      ...
      <div className="card bg-slate-800 border border-slate-700 rounded-lg shadow-sm p-6">
        {loading ? (
          ...
          <div className="overflow-x-auto">
            ...
            {totalPages > 1 && (
              <div className="py-4 flex justify-between items-center text-sm text-gray-500 border-t border-slate-700">
                <span>
