 ...
 * Provides retry mechanism and detailed error information for debugging
 */
        ...
        <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-slate-800 rounded-lg shadow-lg p-6">
            ...
            <div className="text-center">
              <h1 className="text-xl font-semibold text-gray-100 mb-2">Oops! Algo deu errado</h1>
              ...
              {showDetails && error && (
                <details className="mb-6 text-left">
                  ...
                  <div className="bg-slate-700 p-3 rounded text-xs font-mono text-gray-200 overflow-auto max-h-32">
