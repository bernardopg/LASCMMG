...
const MessageContainer = () => {
  ...
  const getMessageClasses = (type) => {
    const baseClasses = 'animate-fade-in message-item rounded-md p-4 mb-3 flex items-start justify-between shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2';
