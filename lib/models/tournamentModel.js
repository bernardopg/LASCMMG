...
async function createTournament(tournament) {
  ...
  const sql = `
    INSERT INTO tournaments (id, name, date, description, num_players_expected, bracket_type, status, state_json, entry_fee, prize_pool, rules, updated_at)
      ...
      for (const tournament of tournaments) {
        ...
        const sql = `
          ...
          ON CONFLICT(id) DO UPDATE SET
            ...
            entry_fee = excluded.entry_fee,     // Novo campo
            prize_pool = excluded.prize_pool, // Novo campo
            rules = excluded.rules,           // Novo campo
